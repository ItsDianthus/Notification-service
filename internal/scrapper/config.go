...
type Config struct {
	...
	FetchGitHub FetchConfig     `mapstructure:"fetch.github"         validate:"required"`
	FetchSO     FetchConfig     `mapstructure:"fetch.stack_overflow" validate:"required"`
}
...
func (c *BotConfig) BaseURL() string {
